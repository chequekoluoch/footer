     ...
     {/* <section className='footer-subscription'>
      ...
      <div className='footer-link-wrapper'>
        ...
        <div className='footer-link-wrapper' style={{display:'flex',flexDirection:'column',width:'30%'}}>
          <div class='footer-link-items' style={{marginBottom:'5rem',marginTop:'14px',display:'flex',fontSize:'12px',flexDirection:'row',justifyContent:'space-between'}}>
            <Link to='/'>Blog</Link>
          ...
          <div class='footer-link-items' style={{fontSize:"9px",marginTop:'5rem'}}>
